...
/**
 * Hook principal que agrupa todas las funcionalidades para operaciones de tienda
 */
export const useProfileByStoreOperations = (storeId: number | string) => {
...
export default useProfileByStoreOperations
