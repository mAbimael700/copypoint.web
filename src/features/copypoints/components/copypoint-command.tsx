...
import { useCopypointModule } from "../storage/useCopypointStorage"
...
export const CopypointCommand = ({ handleOnClick, label = "Select copypoint" }: Props) => {
                            ...
                            {copypoints.map((s) => (
                                ...
                                >
                                    <CheckIcon
                                        className={cn(
                                            "mr-2 h-4 w-4",
                                            currentCopypoint?.id === s.id ? "opacity-100" : "opacity-0"
                                        )}
                                    />
                                    {s.name}
                                </CommandItem>
